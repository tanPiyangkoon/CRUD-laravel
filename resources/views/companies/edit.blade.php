...
<body>
    ...
    <div class="container mt-2">
        ...
        @endif
        <form action="{{route('companies.update', $company->id) }}" method="POST" enctype="multipart">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md12 ">
                    ...
                    <div class="col-md12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="email" value="{{$company->email}}" class="form-control" placeholder="Company Email">
                            @error('email')
                            <div class="alert alert-danger">{{$message}}</div>
                            @enderror
                        </div>
